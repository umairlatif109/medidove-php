...
<body style="width:1000px;  margin:95px 243px;  text-align:-webkit-center;">
					...
					<?php
						...
						$sql  = "SELECT * FROM news WHERE user_id='$select_id'";
...
<h2>Update Service... </h2>
	<form method="post" action="update_news.php?edit_form=<?php echo $user_id; ?>" enctype="multipart/form-data">
		heading:<br>
		...
		<br><br>
		Image:<br>
		<img src="news/<?=$image;?>" height="100px;" width="100px;">
...
$image = $_FILES['image']['name'];
 ...
 $sql = "UPDATE news SET heading='$heading', werbpage='$werbpage', image='$image'	 WHERE user_id='$update_id'";
 }
 else{
  $sql = "UPDATE news SET heading='$heading', werbpage='$werbpage' WHERE user_id='$update_id'";
 }
  ...
  if ($conn->query($sql) === TRUE) {
   ...
   echo "<script>window.open('mange_news.php?updated=Post Updated', '_self')</script>";
