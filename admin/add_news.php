...
$image = time().$_FILES['image']['name'];
	...
	if($_FILES['image']['type']=="image/png" || $_FILES['image']['type']=="image/jpeg" || $_FILES['image']['type']=="image/jpg")
	{
		...
		$sql = "INSERT INTO news(heading,werbpage,image) VALUES ('$heading','$werbpage','$image')";
...
<form method="post" action="add_news.php"enctype="multipart/form-data" style="text-align:-webkit-center;  background-color:#3d7e7e; padding:21px;">
